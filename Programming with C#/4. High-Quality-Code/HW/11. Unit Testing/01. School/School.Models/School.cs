namespace School.Models
{
    ...
    public class School
    {
        ...
        {
            var uniqueNumber = this.GetNexUniqueNumber();
        ...
        public void AddStudentToCourse(Student student, Course course)
        {
            ...
            if (!this.courses.Contains(course))
            {
                throw new ArgumentException("Course does not exist in this school.");
            }
            ...
            {
                throw new ArgumentException(string.Format("Student with number {0} already added in this course.", student.UniqueNumber));
            }
        ...
        private int GetNexUniqueNumber()
        {
