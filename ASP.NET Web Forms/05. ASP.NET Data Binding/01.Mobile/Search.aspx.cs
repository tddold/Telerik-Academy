namespace Mobile
{
    ...
    {
        private IList<Producer> producers = SeedProducer();
        ...
        protected void OnProducerSelectedIndexChangrd(object sender, EventArgs e)
        {
        ...
        private static IList<Producer> SeedProducer()
        {
            ...
            {
                Name = "Cadillac",
                Models = new List<string>() { "Alante", "Devolle", "Eldorado", "Seville" }
            });
        ...
        {
            var engineType = new List<string>()
            {
                "All",
                "Diesel",
                "Petrol",
