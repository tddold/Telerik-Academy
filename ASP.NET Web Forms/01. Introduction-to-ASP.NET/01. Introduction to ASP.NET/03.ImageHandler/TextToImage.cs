namespace _03.ImageHandler
{
    ...
    public class TextToImage : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            this.GenerateImage(context.Response, content, 300, 100, Color.GreenYellow, FontFamily.GenericSansSerif, 18, Brushes.BlueViolet, 0, 0, "image/png,", ImageFormat.Png);
        }

        private void GenerateImage(HttpResponse response, string textToInsert, int width, int height, Color backgroundColor, FontFamily fontFamily, float emSize, Brush brush, float x, float y, string contentType, ImageFormat imageFormat)
        {
