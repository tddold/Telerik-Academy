<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="_02.WebChat._Default" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">

    <asp:ListView runat="server" ID="ListViewMessages"
        ItemType="_02.WebChat.Models.Message"
        DataKeyNames="Id">
        <LayoutTemplate>
    ...
    <asp:Timer ID="TimerChatRefresh" runat="server" Interval="1000" />
