...
function task3() {
    ...
    jsConsole.writeLine('All words found in the text with case sensitive: ' + countWord(text, word, true, true));
    console.log(countWord(text, word, true, true));

    jsConsole.writeLine('All words found in the text without case sensitive: ' + countWord(text, word, true, false));
    ...
    function countWord(text, word, isSubstring, caseSensetive) {
        ...
        //re = new RegExp((format, word), 'gi');
        //var resultRe = text.match(re);
