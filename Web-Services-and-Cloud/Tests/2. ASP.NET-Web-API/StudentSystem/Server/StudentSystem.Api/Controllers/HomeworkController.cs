namespace StudentSystem.Api.Controllers
{
    ...
    public class HomeworkController : BaseController
    {
        ...
        {
            return this.StudentSystemData.Homeworks
                .All()
        ...
        public IHttpActionResult Edit(HomeworkModel homeworkModel)
        {
            ...
            try
            {
                ...
                homework.Id = homeworkModel.HomeworkId;
        ...
        public IHttpActionResult Create(Homework homework)
        {
            ...
            return this.CreatedAtRoute("DefaultApi", new { id = homework.Id }, homework);
        }
        ...
        {
            return this.StudentSystemData.Homeworks.All()
                .Any(e => e.Id == id);
        }
    }
}
