namespace RockBands.Data.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<RockBandsDbContext>
    {
        ...
        private void SeedBands(IRockBandsDbContext context)
        {
            ...
            var acdc = new Band()
            {
                ImageUrl = "http://test.cloudvps.bg/rockbands/images/ac-dc.jpg",
                Name = "AC/DC",
            ...
            {
                ImageUrl = "http://test.cloudvps.bg/rockbands/images/the-beatles.jpg",
                Name = "The Beatles",
                Nationality = "England",
            ...
            {
                ImageUrl = "http://test.cloudvps.bg/rockbands/images/nazareth.jpg",
                Name = "Nazareth",
        ...
        private void SeedAlbums(IRockBandsDbContext context)
        {
            ...
            {
                Name = "Razamanaz",
                ImageUrl = "http://test.cloudvps.bg/rockbands/images/razamanaz.jpg",
                Rating = 10,
                ReleasedAt = new DateTime(1973, 1, 1),
                Src = "razamanaz",
                BandId = 3
            ...
            {
                Name = "Past Masters",
                ImageUrl = "http://test.cloudvps.bg/rockbands/images/past-masters.jpg",
                Rating = 8,
            ...
            {
                Name = "Red Album",
                ImageUrl = "http://test.cloudvps.bg/rockbands/images/red-album.jpg",
                Rating = 6,
                ReleasedAt = new DateTime(1973, 1, 1),
                Src = "red-album",
                BandId = 2
        ...
        private void SeedSongs(IRockBandsDbContext context)
        {
            ...
            {
                Name = "Night Woman",
                ImageUrl = "http://test.cloudvps.bg/rockbands/images/night-woman.jpg",
                Rating = 3,
                Src = "night-woman",
            ...
            {
                Name = "Sold My Soul",
                ImageUrl = "http://test.cloudvps.bg/rockbands/images/woke-up-this-morning.jpg",
                Rating = 2,
                Src = "sold-my-soul",
